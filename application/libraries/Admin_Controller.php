...
class Admin_Controller extends MY_Controller 
{
	...
	public function __construct(){
		parent::__construct();
        $this->data['meta_title'] = 'Biljeznica';
        ...
        $CI->acl_config = array();
        $CI->acl_config['ADMIN'] = array('enquire', 'dashboard', 'estate', 'page', 'settings', 'slideshow', 'user', 'upload', 'order', 'upload_slideshow', 'upload_estate', 'upload_user', 'news', 'ads', 'expert', 'companies', 'upload_ads', 'showroom', 'upload_showroom', 'expert');
        $CI->acl_config['AGENT'] = array('enquire', 'enquire/edit', 'dashboard', 'estate/index', 'estate/edit', 'user/edit', 'upload', 'order', 'upload_estate', 'upload_user');
        $CI->acl_config['USER'] = array('order', 'upload_estate', 'upload');
