...
<div class="wrap-search">
    <div class="container">
        <ul id="search_option_4" class="menu-onmap">
            {options_values_li_4}
        ...
        <div class="search-form">
            <form class="form-inline">
                ...
                <input id="search_option_36_from" type="text" class="span3 mPrice" placeholder="{lang_Fromprice} ({options_suffix_36})" />
                <input id="search_option_36_to" type="text" class="span3 xPrice" placeholder="{lang_Toprice} ({options_suffix_36})" />
