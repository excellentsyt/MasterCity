...
ALTER TABLE `enquire` CHANGE `property_id` `property_id` INT( 11 ) NULL DEFAULT NULL ;
...
-- Option video
INSERT INTO `option` (`id`,  `parent_id`, `type`, `visible`, `is_locked`, `is_frontend`, `order`) VALUES (9, '0', 'CATEGORY', 0, '1', 0, 100); 
INSERT INTO `option_lang` (`language_id`, `option_id`, `values`, `suffix`, `option`) VALUES (1, 9, '', '', 'Multimedia');
INSERT INTO `option_lang` (`language_id`, `option_id`, `values`, `suffix`, `option`) VALUES (2, 9, '', '', 'Multimedia');  

INSERT INTO `option` (`id`,  `parent_id`, `type`, `visible`, `is_locked`, `is_frontend`, `order`) VALUES (12, '9', 'INPUTBOX', 0, '1', 0, 101); 
INSERT INTO `option_lang` (`language_id`, `option_id`, `values`, `suffix`, `option`) VALUES (1, 12, '', '', 'Embed video');
INSERT INTO `option_lang` (`language_id`, `option_id`, `values`, `suffix`, `option`) VALUES (2, 12, '', '', 'Integrirani video');  
